...
module.exports = {
  ...
  prepare_vout: function(vout, txid, vin, cb) {
    ...
    module.exports.syncLoop(vout.length, function (loop) {
      ...
      if (vout[i].scriptPubKey.type != 'nonstandard' && vout[i].scriptPubKey.type != 'nulldata' && vout[i].scriptPubKey.type != 'zerocoinmint') {
        //console.log("scriptPubKey = " + vout[i].scriptPubKey.type)
